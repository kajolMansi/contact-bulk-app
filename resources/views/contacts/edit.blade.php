...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <form id="form" novalidate enctype="multipart/form-data" action="{{ route('contacts.update', $contact->id) }}" method="POST">
        @csrf
        @method('POST')
        ...
        <div class="form-group">
            ...
            <input type="number" id="phone" name="phone" value="{{ old('phone', $contact->phone) }}" maxlength="10" required>
            <span class="validation-icon">✓</span>
            <div class="error-message" id="messageError">Please enter your Mobile number</div>
        </div>

        <button type="submit" value="submit">Update Contact</button>
    </form>
</div>
    </body>
</html>
